...
description: >
  ...
  understanding, resolving each branch of the decision tree. Use when the user wants to
...
Stop when the decision space is mapped — don't pad the interview for a trivial change.
